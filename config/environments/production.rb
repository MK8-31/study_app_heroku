...
Rails.application.configure do
  ...
  #production環境でもdevelopment環境と同じようにエラーを表示できる
  config.consider_all_requests_local       = false #defaultではfalse
  ...
  # config.active_job.queue_name_prefix = "study_app_aws_production"
  ...
  config.action_mailer.default_url_options = {  :host => 'https://intense-journey-27786.herokuapp.com' }
